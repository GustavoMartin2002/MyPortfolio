      ...
      <div className="flex gap-10 max-[400px]:flex-col">
        ...
        >
          <div className="flex flex-col w-28 h-28 py-3 px-5 bg-[#106dbe] rounded-lg max-sm:w-24 max-sm:h-24">
            ...
            <span className="text-sm text-center font-bold mt-2 select-none max-sm:text-xs">WhatsApp</span>
          </div>
        </motion.a>
        ...
        >
          <div className="flex flex-col w-28 h-28 py-3 px-5 bg-[#106dbe] rounded-lg max-sm:w-24 max-sm:h-24">
            ...
            <span className="text-sm text-center font-bold mt-2 select-none max-sm:text-xs">Email</span>
          </div>
        </motion.a>
        ...
        >
          <div className="flex flex-col w-28 h-28 py-3 px-5 bg-[#106dbe] rounded-lg max-sm:w-24 max-sm:h-24">
            ...
            <span className="text-sm text-center font-bold mt-2 select-none max-sm:text-xs">Linkedin</span>
          </div>
        </motion.a>
      </div>
    </section>
